...
(function ($, undefined) {
  ...
  function installDebouncedScroll(threshold, element) {
    const notify = debounce(threshold, (e) => {
  ...
  AbstractSelect2 = clazz(Object, {
    ...
    init(opts) {
      ...
      $(this.container).on('change', '.select2-input', (e) => {
        e.stopPropagation();
      });
      $(this.dropdown).on('change', '.select2-input', (e) => {
        e.stopPropagation();
      });
      ...
      this.dropdown.on('click mouseup mousedown', (e) => {
        e.stopPropagation();
      });
    ...
    // abstract
    triggerSelect(data) {
      const evt = $.Event('select2-selecting', {val: this.id(data), object: data});
  ...
  SingleSelect2 = clazz(AbstractSelect2, {
    ...
    prepareOpts() {
      ...
      if (opts.element.get(0).tagName.toLowerCase() === 'select') {
        ...
        opts.initSelection = function (element, callback) {
          const selected = element.find('option').filter(function () {
