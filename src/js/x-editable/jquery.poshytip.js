...
(function ($) {
  ...
  $.Poshytip.prototype = {
    init() {
      ...
      const title = this.$elm.attr('title');
    ...
    mouseleave(e) {
      ...
      const title = this.$elm.data('title.poshytip');
      if (title !== null) {
    ...
    update(content, dontOverwriteOption) {
      ...
      let self       = this,
          newContent = typeof content === 'function' ?
            content.call(this.$elm[0], (newContent) => {
    ...
    refresh(async) {
      ...
      const $table = this.$tip.find('> table.tip-table');
      if (ie6) {
    ...
    display(hide) {
      const active = this.$tip.data('active');
      ...
      if ((this.opts.slide && this.pos.arrow || this.opts.fade) && (hide && this.opts.hideAniDuration || !hide && this.opts.showAniDuration)) {
        ...
        if (this.opts.slide && this.pos.arrow) {
          ...
          const val = parseInt(this.$tip.css(prop));
  ...
  $.fn.poshytip = function (options) {
    if (typeof options === 'string') {
      ...
      return this.each(function () {
        const poshytip = $(this).data('poshytip');
        if (poshytip && poshytip[method]) {
          poshytip[method](...args);
        }
      });
    }

    const opts = $.extend({}, $.fn.poshytip.defaults, options);
